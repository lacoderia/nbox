...
station6 = Station.new(position:48, number:7, description: 'Cardio')
station7 = Station.new(position:53, number:8, description: 'Costal vertical XL')
station8 = Station.new(position:71, number:9, description: 'Pera doble')
station9 = Station.new(position:74, number:10, description: 'Costal vertical')
station10 = Station.new(position:89, number:11, description: 'Costal horizontal')
station11 = Station.new(position:101, number:12, description: 'Costal vertical')
