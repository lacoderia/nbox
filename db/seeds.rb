...
station2 = Station.new(position:21, number:14, description: 'Ring')
station3 = Station.new(position:24, number:2, description: 'Pera sencilla')
station4 = Station.new(position:25, number:3, description: 'Cojín cuadrado')
station5 = Station.new(position:26, number:4, description: 'Cojín cuadrado')
station6 = Station.new(position:47, number:12, description: 'Costal bola')
station7 = Station.new(position:48, number:13, description: 'Cardio')
station8 = Station.new(position:53, number:5, description: 'Costal vertical XL')
station9 = Station.new(position:71, number:6, description: 'Pera doble')
...
Config.create(key: "free_classes_start_date", value: (Time.zone.now + 1.month).strftime("%FT%T.%L%:z") )
Config.create(key: "free_classes_end_date", value: (Time.zone.now + 2.month).strftime("%FT%T.%L%:z") )
