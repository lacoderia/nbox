...
station2 = Station.new(position:21, number:2)
station3 = Station.new(position:24, number:3)
station4 = Station.new(position:26, number:4)
station5 = Station.new(position:35, number:5)
station6 = Station.new(position:47, number:6)
station7 = Station.new(position:53, number:7)
station8 = Station.new(position:71, number:8)
station9 = Station.new(position:74, number:9)
station10 = Station.new(position:89, number:10)
station11 = Station.new(position:101, number:11)
station12 = Station.new(position:107, number:12)
station13 = Station.new(position:112, number:13)
station14 = Station.new(position:121, number:14)
